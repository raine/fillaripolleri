...
runTestList('parseFrameSize()', R.pipe(
  ...
  // ['blah\nRungon koko XXS\nblah', '2XS'],
  // ['Rengaskoko', null],
  ['Runko suhteellisen', null]
  // ["blah\nMoser 111 Ultegra hiilikuitu 56 cm -vm 2013 \nblah", '56cm'],
  // Rungon﻿ koko (lisä myös﻿﻿ otsikkoon): M
  // only in title: https://www.fillaritori.com/topic/135984-felt-qx85w-49cm-vihti-650e/
  // Rungon koko S
  // Rungon koko (lisää myös otsikkoon): 22"/55cm (XL)
])
