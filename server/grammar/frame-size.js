...
function id(x) { return x[0]; }
 ...
 const wrapWithType = (type) => (value) => ({ type, value }); var grammar = {
    ...
    {"name": "any$ebnf$1$subexpression$1", "symbols": [/./]},
    {"name": "any$ebnf$1$subexpression$1", "symbols": [{"literal":"\n"}]},
    {"name": "any$ebnf$1", "symbols": ["any$ebnf$1", "any$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
