...
function id(x) { return x[0]; }
 ...
 const wrapWithType = (type) => (value) => ({ type, value }); var grammar = {
    ...
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$1"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$2", "symbols": [{"literal":"2"}, /[xX]/, /[lL]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$2"], "postprocess": R.head},
    ...
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$4"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$5", "symbols": [/[lL]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$5"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$6", "symbols": [/[mM]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$6"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$7", "symbols": [/[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$7"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$8", "symbols": [/[xX]/, /[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$8"], "postprocess": R.head},
    ...
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$10"], "postprocess": R.head},
    {"name": "frame_size_tshirt$subexpression$1$subexpression$11", "symbols": [{"literal":"3"}, /[xX]/, /[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "frame_size_tshirt$subexpression$1", "symbols": ["frame_size_tshirt$subexpression$1$subexpression$11"], "postprocess": R.head},
    {"name": "frame_size_tshirt$ebnf$1", "symbols": [/./], "postprocess": id},
    {"name": "frame_size_tshirt$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "frame_size_tshirt", "symbols": ["frame_size_tshirt$subexpression$1", "frame_size_tshirt$ebnf$1"], "postprocess":  (d, l, rej) => {
          console.log(d)
